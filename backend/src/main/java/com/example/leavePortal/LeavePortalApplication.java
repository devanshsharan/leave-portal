...
public class LeavePortalApplication implements CommandLineRunner {
	...
	private void createDefaultAdminIfMissing() {
		...
		if (adminAccounts.isEmpty()) {
			try {
				Employee admin = createEmployee("admin", "a@123", Employee.Role.ADMIN, "admin",
						"divyansh27032002@gmail.com", "9876543210");
				Employee rohan = createEmployee("rohan", "r@123", Employee.Role.EMPLOYEE, "Rohan Singh",
						"rohhhhhan1123@gmail.com", "9776543210");
				Employee sohan = createEmployee("sohan", "s@123", Employee.Role.MANAGER, "Sohan",
						"soooohan123@gmail.com", "9676543210");
				Employee mohan = createEmployee("mohan", "m@123", Employee.Role.MANAGER, "Mohan Gupta",
						"devanshshaaaaaaaran.gupta@beehyv.com", "5576543210");
				Employee ram = createEmployee("ram", "r@123", Employee.Role.MANAGER, "Ram Radhe",
						"raaaaam123@gmail.com", "9076543210");
				Employee shyam = createEmployee("shyam", "s@123", Employee.Role.MANAGER, "Shyam",
						"devanshsharangupta@gmail.com", "4876543210");
	...
	private static List<LeaveRequestDto> getLeaveRequestDtos() {
		...
		LeaveRequestDto leaveRequest12 = new LeaveRequestDto(
				3, LocalDate.of(2024, 5, 14), LocalDate.of(2024, 5, 14), "HOSPITALIZATION",
				"Hospital admission for a relative");
		...
		return List.of(
				...
				leaveRequest7, leaveRequest8, leaveRequest9, leaveRequest10, leaveRequest11, leaveRequest12,
				leaveRequest13,
				leaveRequest14, leaveRequest15, leaveRequest16, leaveRequest17, leaveRequest18, leaveRequest19);
	}

	private Employee createEmployee(String username, String password, Employee.Role role, String name, String email,
			String number) {
